       ...
       <Stack gap="60px" sx={{flexDirection:{lg:'row',p:'20px',alignItems:'center'}}}>
         ...
         <Stack sx={{gap:{lg:'35px' ,xs:'20px'}}}>
            ...
            <Typography variant="h6">
                ...
                is one of the best
                exercise to target your {target} . It will help you improve your
                mood and gain energy
            </Typography>
            {extraDetail.map((item)=>(<Stack key={item.name} direction="row" gap="24px">
              <Button sx={{background:'#fff2db',borderRadius:'50%',width:'100px'}}>
                <img src={item.icon} alt={bodyPart} style={{width:'50px',height:'50px'}}/></Button>
